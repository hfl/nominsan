...
class AlternativeTitlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alternative_title" do
    assert_difference('AlternativeTitle.count') do
      post alternative_titles_url, params: { alternative_title: { alternative_title: @alternative_title.alternative_title, title_id: @alternative_title.title_id } }
    end
  ...
  test "should update alternative_title" do
    patch alternative_title_url(@alternative_title), params: { alternative_title: { alternative_title: @alternative_title.alternative_title, title_id: @alternative_title.title_id } }
