...
class CoveragesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coverage" do
    assert_difference('Coverage.count') do
      post coverages_url, params: { coverage: { coverage: @coverage.coverage, coverage_type_id: @coverage.coverage_type_id, literature_id: @coverage.literature_id } }
    end
  ...
  test "should update coverage" do
    patch coverage_url(@coverage), params: { coverage: { coverage: @coverage.coverage, coverage_type_id: @coverage.coverage_type_id, literature_id: @coverage.literature_id } }
