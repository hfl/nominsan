...
class DegreesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create degree" do
    assert_difference('Degree.count') do
      post degrees_url, params: { degree: { displine: @degree.displine, grantor: @degree.grantor, level: @degree.level, literature_id: @degree.literature_id } }
    end
  ...
  test "should update degree" do
    patch degree_url(@degree), params: { degree: { displine: @degree.displine, grantor: @degree.grantor, level: @degree.level, literature_id: @degree.literature_id } }
