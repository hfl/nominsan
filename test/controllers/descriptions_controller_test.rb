...
class DescriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create description" do
    assert_difference('Description.count') do
      post descriptions_url, params: { description: { description: @description.description, description_type_id: @description.description_type_id, literature_id: @description.literature_id } }
    end
  ...
  test "should update description" do
    patch description_url(@description), params: { description: { description: @description.description, description_type_id: @description.description_type_id, literature_id: @description.literature_id } }
