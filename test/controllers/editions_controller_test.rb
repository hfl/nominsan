...
class EditionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create edition" do
    assert_difference('Edition.count') do
      post editions_url, params: { edition: { edition: @edition.edition, edition_type_id: @edition.edition_type_id, literature_id: @edition.literature_id } }
    end
  ...
  test "should update edition" do
    patch edition_url(@edition), params: { edition: { edition: @edition.edition, edition_type_id: @edition.edition_type_id, literature_id: @edition.literature_id } }
