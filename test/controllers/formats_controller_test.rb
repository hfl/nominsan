...
class FormatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create format" do
    assert_difference('Format.count') do
      post formats_url, params: { format: { format_extent_id: @format.format_extent_id, format_mime_id: @format.format_mime_id, literature_id: @format.literature_id, scan_resolution: @format.scan_resolution } }
    end
  ...
  test "should update format" do
    patch format_url(@format), params: { format: { format_extent_id: @format.format_extent_id, format_mime_id: @format.format_mime_id, literature_id: @format.literature_id, scan_resolution: @format.scan_resolution } }
