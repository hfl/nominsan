...
class IdentifierTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create identifier_type" do
    assert_difference('IdentifierType.count') do
      post identifier_types_url, params: { identifier_type: { about: @identifier_type.about, code: @identifier_type.code, name: @identifier_type.name } }
    end
  ...
  test "should update identifier_type" do
    patch identifier_type_url(@identifier_type), params: { identifier_type: { about: @identifier_type.about, code: @identifier_type.code, name: @identifier_type.name } }
