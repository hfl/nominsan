...
class IdentifiersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create identifier" do
    assert_difference('Identifier.count') do
      post identifiers_url, params: { identifier: { identifier: @identifier.identifier, identifier_type_id: @identifier.identifier_type_id, literature_id: @identifier.literature_id } }
    end
  ...
  test "should update identifier" do
    patch identifier_url(@identifier), params: { identifier: { identifier: @identifier.identifier, identifier_type_id: @identifier.identifier_type_id, literature_id: @identifier.literature_id } }
