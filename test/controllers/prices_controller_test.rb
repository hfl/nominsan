...
class PricesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post prices_url, params: { price: { about: @price.about, currency_id: @price.currency_id, literature_id: @price.literature_id, number: @price.number } }
    end
  ...
  test "should update price" do
    patch price_url(@price), params: { price: { about: @price.about, currency_id: @price.currency_id, literature_id: @price.literature_id, number: @price.number } }
