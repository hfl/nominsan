...
class PublishersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create publisher" do
    assert_difference('Publisher.count') do
      post publishers_url, params: { publisher: { city: @publisher.city, literature_id: @publisher.literature_id, name: @publisher.name } }
    end
  ...
  test "should update publisher" do
    patch publisher_url(@publisher), params: { publisher: { city: @publisher.city, literature_id: @publisher.literature_id, name: @publisher.name } }
