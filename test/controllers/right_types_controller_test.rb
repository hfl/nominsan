...
class RightTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create right_type" do
    assert_difference('RightType.count') do
      post right_types_url, params: { right_type: { about: @right_type.about, code: @right_type.code, name: @right_type.name } }
    end
  ...
  test "should update right_type" do
    patch right_type_url(@right_type), params: { right_type: { about: @right_type.about, code: @right_type.code, name: @right_type.name } }
