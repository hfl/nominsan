...
class SourcesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create source" do
    assert_difference('Source.count') do
      post sources_url, params: { source: { literature_id: @source.literature_id, source: @source.source } }
    end
  ...
  test "should update source" do
    patch source_url(@source), params: { source: { literature_id: @source.literature_id, source: @source.source } }
