...
class SubjectTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subject_type" do
    assert_difference('SubjectType.count') do
      post subject_types_url, params: { subject_type: { about: @subject_type.about, code: @subject_type.code, name: @subject_type.name } }
    end
  ...
  test "should update subject_type" do
    patch subject_type_url(@subject_type), params: { subject_type: { about: @subject_type.about, code: @subject_type.code, name: @subject_type.name } }
