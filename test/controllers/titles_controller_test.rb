...
class TitlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create title" do
    assert_difference('Title.count') do
      post titles_url, params: { title: { literature_id: @title.literature_id, title: @title.title } }
    end
  ...
  test "should update title" do
    patch title_url(@title), params: { title: { literature_id: @title.literature_id, title: @title.title } }
