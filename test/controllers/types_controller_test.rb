...
class TypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create type" do
    assert_difference('Type.count') do
      post types_url, params: { type: { cadal_type_id: @type.cadal_type_id, literature_id: @type.literature_id } }
    end
  ...
  test "should update type" do
    patch type_url(@type), params: { type: { cadal_type_id: @type.cadal_type_id, literature_id: @type.literature_id } }
