...
class DescriptionsTest < ApplicationSystemTestCase
  ...
  test "creating a Description" do
    ...
    fill_in "Description", with: @description.description
    fill_in "Description Type", with: @description.description_type_id
    fill_in "Literature", with: @description.literature_id
